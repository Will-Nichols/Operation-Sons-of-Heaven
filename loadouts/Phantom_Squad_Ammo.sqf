...
for "_i" from 1 to 2 do {_this addItemToBackpack "vme_camonet_med_FOR";};
for "_i" from 1 to 2 do {_this addItemToBackpack "vme_camonet_FOR";};
_this addItemToBackpack "ACE_EntrenchingTool";
for "_i" from 1 to 3 do {_this addItemToBackpack "VME_QJB95_1_75Rnd_DBP10";};
for "_i" from 1 to 2 do {_this addItemToBackpack "VME_QJY88_200Rnd_DBP10";};
